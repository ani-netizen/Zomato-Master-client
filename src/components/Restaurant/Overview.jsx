...
function Overview() {
  ...
  return (
    <>
      <div className="flex flex-col gap-5 md:flex-row justify-between relative">
        <div className="w-full md:w-9/12 lg:w-8/12">
          ...
          <div className="flex justify-between items-center">
            ...
            <Link to={`/restaurant/${id}/menu`}>
              <span className="flex items-center gap-1 text-zomRed-400">
        ...
        <aside
          ...
          className="hidden md:flex md:w-3/12 lg:w-4/12 sticky rounded-xl top-2 bg-white p-3 shadow-md flex-col gap-4"
        >
          <MapView
            title="McDonald's"
            phoneNumber="+919876543210"
