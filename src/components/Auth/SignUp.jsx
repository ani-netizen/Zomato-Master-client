                  ...
                  <form className="flex flex-col gap-5">
                    <div className="w-full flex flex-col gap-2">
                      ...
                      <input
                        ...
                        className="w-full border border-gray-400 px-3 py-2 rounded-lg focus:outline-none focus:border-zomRed-400"
                      />
                    </div>
                    <div className="w-full flex flex-col gap-2">
                    ...
                    <div>
                      <input
                        ...
                        type="submit"
                        onClick={submit}
                        className="w-full text-center bg-zomRed-400 text-white py-2 rounded-lg"
                      />
                    </div>
                  </form>
                </div>
